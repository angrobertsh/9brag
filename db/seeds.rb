...
User.create(name: "Jarno", password: "spoopy", url: "http://res.cloudinary.com/dujcpxlhk/image/upload/v1473375123/liqxi5ny7pwfqsa0mj4j.jpg")
User.create(name: "Simperella", password: "spoopy", url: "http://res.cloudinary.com/dujcpxlhk/image/upload/v1473375188/iqt3yda1n72icjujrnws.jpg")
...
Comment.create(user_id: 1, meme_id: 1, body: "cool story bro")
...
Comment.create(user_id: 1, meme_id: 6, body: "cuba gooding jr could get it")
...
Vote.create(votable_type: "Meme", votable_id: 3, vote_val: -1, user_id: 12)
