...
Meme.create(url: "http://res.cloudinary.com/dujcpxlhk/image/upload/v1473132871/chickenspiral_fplreu.jpg", title: "I for one welcome our new poultry overlords", user_id: 1)
Meme.create(url: "http://res.cloudinary.com/dujcpxlhk/image/upload/v1473135475/fwp2_lmqod3.jpg", title: "3meta5me", user_id: 3)
Meme.create(url: "http://res.cloudinary.com/dujcpxlhk/image/upload/v1473132862/donaldbutt_pg7sff.jpg", title: "Me on snapchat", user_id: 9)
Meme.create(url: "http://res.cloudinary.com/dujcpxlhk/image/upload/v1473134902/library_qm6nfd.jpg", title: "The library, open since 1733", user_id: 4)
Meme.create(url: "http://res.cloudinary.com/dujcpxlhk/image/upload/v1473132943/throwbreadonme_zsnxvc.jpg", title: "ok", user_id: 5)
Meme.create(url: "http://res.cloudinary.com/dujcpxlhk/image/upload/c_crop/v1473137466/succ_oqx4sk.jpg", title: "guy what are you hungry for???", user_id: 1)
Meme.create(url: "http://res.cloudinary.com/dujcpxlhk/image/upload/v1473132901/nailpolish_hozeq5.jpg", title: "When they don't have your color", user_id: 4)
...
Meme.create(url: "http://res.cloudinary.com/dujcpxlhk/image/upload/v1473132885/sicklady_qo6rwt.jpg", title: "Medicine", user_id: 2)
Meme.create(url: "http://res.cloudinary.com/dujcpxlhk/image/upload/v1473135484/scoob2_ft2lwe.jpg", title: "That one friend", user_id: 2)
