...
User.create(name: "Jarno", password: "spoopy", url: "http://res.cloudinary.com/dujcpxlhk/image/upload/v1473281545/o5wdjmofpdjtwpnxoiu5.jpg")
User.create(name: "Simperella", password: "spoopy", url: "http://res.cloudinary.com/dujcpxlhk/image/upload/v1473281545/o5wdjmofpdjtwpnxoiu5.jpg")
User.create(name: "Poushtart", password: "spoopy", url: "http://res.cloudinary.com/dujcpxlhk/image/upload/v1473281545/o5wdjmofpdjtwpnxoiu5.jpg")
User.create(name: "CaNdYcAnE748", password: "spoopy", url: "http://res.cloudinary.com/dujcpxlhk/image/upload/v1473281545/o5wdjmofpdjtwpnxoiu5.jpg")
...
User.create(name: "PeplosKore", password: "spoopy", url: "http://res.cloudinary.com/dujcpxlhk/image/upload/v1473281545/o5wdjmofpdjtwpnxoiu5.jpg")
User.create(name: "obeocookiE", password: "spoopy", url: "http://res.cloudinary.com/dujcpxlhk/image/upload/v1473281545/o5wdjmofpdjtwpnxoiu5.jpg")
User.create(name: "Ranaferboi", password: "spoopy", url: "http://res.cloudinary.com/dujcpxlhk/image/upload/v1473281545/o5wdjmofpdjtwpnxoiu5.jpg")
User.create(name: "JolenejoleneJOLEEENE", password: "spoopy", url: "http://res.cloudinary.com/dujcpxlhk/image/upload/v1473281545/o5wdjmofpdjtwpnxoiu5.jpg")
User.create(name: "password123", password: "justkidding", url: "http://res.cloudinary.com/dujcpxlhk/image/upload/v1473281545/o5wdjmofpdjtwpnxoiu5.jpg")
User.create(name: "Guest", password: "123456", url: "http://res.cloudinary.com/dujcpxlhk/image/upload/v1473281545/o5wdjmofpdjtwpnxoiu5.jpg")
User.create(name: "Troll", password: "lololxd", url: "http://res.cloudinary.com/dujcpxlhk/image/upload/v1473281545/o5wdjmofpdjtwpnxoiu5.jpg")
...
Meme.create(url: "http://res.cloudinary.com/dujcpxlhk/image/upload/v1473292110/fesppljfzhadmpov3r59.jpg", title: "gooby pls", user_id: 12)
...
Tag.create(meme_id: 12, tagname_id: 13)
...
Comment.create(user_id: 12, meme_id: 1, body: "wen u go 2 park u go feed pigeons")
...
Comment.create(user_id: 12, meme_id: 4, body: "lol its lit -Nancy")
Comment.create(user_id: 12, meme_id: 5, body: "nanxinanxinanxi")
Comment.create(user_id: 12, meme_id: 6, body: "y u no lms nancy")
...
Vote.create(votable_type: "Meme", votable_id: 1, vote_val: 1, user_id: 10)
Vote.create(votable_type: "Meme", votable_id: 1, vote_val: 1, user_id: 11)
Vote.create(votable_type: "Meme", votable_id: 1, vote_val: 1, user_id: 12)
...
Vote.create(votable_type: "Meme", votable_id: 12, vote_val: -1, user_id: 11)
Vote.create(votable_type: "Meme", votable_id: 12, vote_val: -1, user_id: 12)
