...
Meme.create(url: "http://res.cloudinary.com/dujcpxlhk/image/upload/v1473096287/wut_yytgte.jpg", title: "Cat", user_id: 1, ourTags: "cat")
Meme.create(url: "http://res.cloudinary.com/dujcpxlhk/image/upload/v1473096287/wut_yytgte.jpg", title: "Dog", user_id: 2, ourTags: "doge")
Meme.create(url: "http://res.cloudinary.com/dujcpxlhk/image/upload/v1473096287/wut_yytgte.jpg", title: "SO FUNNY L0L", user_id: 3, ourTags: "wenty, horrible")
Meme.create(url: "http://res.cloudinary.com/dujcpxlhk/image/upload/v1473096287/wut_yytgte.jpg", title: "hieeee", user_id: 4, ourTags: "cat")
Meme.create(url: "http://res.cloudinary.com/dujcpxlhk/image/upload/v1473096287/wut_yytgte.jpg", title: "star war", user_id: 5, ourTags: "wenty, doge")
Meme.create(url: "http://res.cloudinary.com/dujcpxlhk/image/upload/v1473096287/wut_yytgte.jpg", title: "mansome", user_id: 1, ourTags: "cat, Doge")
Meme.create(url: "http://res.cloudinary.com/dujcpxlhk/image/upload/v1473096287/wut_yytgte.jpg", title: "FREE SPEECH 5EVER", user_id: 4, ourTags: "wenty, nsfw, horrible")
Meme.create(url: "http://res.cloudinary.com/dujcpxlhk/image/upload/v1473096287/wut_yytgte.jpg", title: "ladsfkj", user_id: 5, ourTags: "NSFW")
Meme.create(url: "http://res.cloudinary.com/dujcpxlhk/image/upload/v1473096287/wut_yytgte.jpg", title: "Jarno is a secret character", user_id: 2, ourTags: "HORRIBLE, doge")
Meme.create(url: "http://res.cloudinary.com/dujcpxlhk/image/upload/v1473096287/wut_yytgte.jpg", title: "luluguthackednub", user_id: 9, attribution: "https://www.10thousandgig.com", ourTags: "nsfw")
Meme.create(url: "http://res.cloudinary.com/dujcpxlhk/image/upload/v1473096287/wut_yytgte.jpg", title: "Chicken Parmesan is a secret Character", user_id: 1, ourTags: "cat, doge")
Meme.create(url: "http://res.cloudinary.com/dujcpxlhk/image/upload/v1473096287/wut_yytgte.jpg", title: "Seen at the terminal", user_id: 1, ourTags: "doge, cat")
